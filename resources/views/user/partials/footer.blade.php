    ...
    <div class="container-fluid">
                        ...
                        @for ($n = 1; $n <= 2; $n++)
                            <div class="duration-300 px-6 py-3 rounded-full border-white border-primary-hover flex items-center gap-4"
                                ...
                                <span class="" style="margin-left:30px;">
                                    @if ($n == 1)
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            class="feather feather-phone-call text-white text-2xl">
                                            <path
                                    ...
                                    @elseif($n == 2)
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="feather feather-map-pin text-white text-2xl">
                                ...
                                <div class="flex flex-col w-full">
                                    @if ($n == 1)
                                        <a class="text-3xl tracking-wider text-white border-primary-hover"
                                            href="tel:{{ optional($business)->phone }}">{{ optional($business)->phone }}</a>
                                    @elseif($n == 2)
                                        <a class="text-3xl tracking-wider text-white border-primary-hover"
                                            href="{{ $business->google_map_link ?? '' }}" target="_blank">Find Our
                                            Store</a>
                                    @endif
                                </div>
                        ...
                        <ul class="social__shear d-flex">
                            <li class="social__shear--list">
                                <a class="social__shear--list__icon" target="_blank"
                                    href="{{ optional($business)->facebook }}">
                            ...
                            <li class="social__shear--list">
                                <a class="social__shear--list__icon" target="_blank"
                                    href="{{ optional($business)->instagram }}">
                            ...
                            <li class="social__shear--list">
                                <a class="social__shear--list__icon" target="_blank"
                                    href="{{ optional($business)->youtube }}">
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-end row">
            <div class="col-md-4">
                ...
                <p class="copyright__content text-ofwhite m-0">
                    <a class="copyright__content--link text-white" style="text-decoration:none;"
                        href="https://faraitltd.com/" target="_blank"> &copy; {{ date('Y') }} Thanks From
...
@include('user.inc.messenger')
@include('user.inc.facebook')
